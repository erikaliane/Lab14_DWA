...
export class TiendasComponent implements OnInit{
  ...
  markers: MarkerProperties[] = [
    ...
    { position: { lat: -12.094951, lng: -77.040214 }, 
      ...
      info: 'ciudad de los reyes'
       ...
       //MIRAFLORES
    { position: { lat: -12.134322, lng: -77.026372 }, 
  ...
  verLarcomar(){
    const LarcomarLatLng = new google.maps.LatLng(-12.134322, -77.026372);
    this.map.setCenter(LarcomarLatLng);
    this.map.setZoom(17);
  }
